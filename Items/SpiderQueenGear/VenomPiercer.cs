...
namespace AgheriumMod.Items.SpiderQueenGear
{
	public class VenomPiercer : ModItem
	{
        public override void SetStaticDefaults()
        {
			...
			Tooltip.SetDefault("Ignores NPC immunity frames");
        }
        ...
        public override bool Shoot(Player player, ref Microsoft.Xna.Framework.Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int num119 = 0; num119 < num118; num119++)
            {
                ...
                int laser = Projectile.NewProjectile(vector2.X + value9.X, vector2.Y + value9.Y, speedX, speedY, 282, (int)((double)damage * 0.75f), knockBack, player.whoAmI, 0.0f, 0.0f);
