...
{
    public class RorbertsStare : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("RorbertsStareProj");   //This defines what type of projectile this weapon will shot
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "MaterialBlob", 17);
