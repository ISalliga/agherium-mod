...
{
    public class Atomizer : ModProjectile
    {
		int dustBurstTime = 0;
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, mod.ProjectileType("AtomExplosion"), 45, 0, Main.myPlayer, 0f, 0f);
        }
    }
}