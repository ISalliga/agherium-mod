...
namespace AgheriumMod.Projectiles
{
	public class EnergizerProj : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
        {
			...
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, Main.rand.Next(-2, 3), Main.rand.Next(-2, 3), mod.ProjectileType("EnergizerCloud"), 5, 0f, Main.myPlayer, 0f, 0f);
        }
	}
}